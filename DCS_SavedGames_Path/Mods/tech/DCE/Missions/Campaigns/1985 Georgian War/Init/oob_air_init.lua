...
oob_air = {
	...
	-------------------- Gudauta (LimitedParkNb = 31) -------------------------
	-------------------- Sochi-Adler (LimitedParkNb = 68) -------------------------

	-------------------- KHASHURI FARP LM84 (LimitedParkNb = ) -------------------------
	-------------------- GORI FARP MM25 (LimitedParkNb = ) -------------------------
	-------------------- AMBROLAURI FARP LN41 (LimitedParkNb =  -------------------------
	...
	-------------------- Gelendzhik (LimitedParkNb = 13) -------------------------
	-------------------- Novorossiysk (LimitedParkNb = 37) -------------------------
	-------------------- Krymsk (LimitedParkNb = 57) -------------------------
	-------------------- Anapa-Vityazevo (LimitedParkNb = 92) -------------------------
	-------------------- Krasnodar-Center (LimitedParkNb = 56) -------------------------
	-------------------- Krasnodar-Pashkovsky (LimitedParkNb = 19) -------------------------
	...
	-------------------- Taftanaz Helibase (LimitedParkNb = 48) ----------------		
		...
		-- 16th Squadron				SA342Minigun	6+18			Lebanon				Strike CAS Soft
		-- 14th Squadron				SA342Mistral	6+18			Lebanon				Strike CAS Soft
		-- 15th Squadron				SA342M			6+18			Lebanon				Strike CAS Soft
