...
db_loadouts = {
	...
	["M-2000C"] = { -- 1983 SI -> OK <- 
		...
		["Escort"] = {
			["MagicII*2, S-530D*2, FT*1 bomber@normal altitude"] = {
				attributes = {},
				role = "escort_bomber",
				role_altitude = "normal",
				weapons = {-- task dedicated weapons
	...
	["C-101CC"] = {--
		...
		["Strike"] = {
			...
			["CAS Rockets-Bombs, Mk-82*2, Lau-68*2(14 Hydra Rockets attacker @ low altitude"] = {
				role = "attacker",
				role_altitude = "low",
				coalition = "blue",
				minscore = 0.0,
			...
			["CAS Bombs, Br-25*2, Mk-82*2, AIM-9P*2 attacker @ normal altitude"] = {
				role = "attacker",
				role_altitude = "normal",
				coalition = "blue",
				minscore = 0.0,
			...
			["CAS Cluster Bombs, Belouga*2, AIM-9P*2, DEFA 553 Cannon attacker @ low altitude  95% Fuel"] = {
				role = "attacker",
				role_altitude = "normal",
				coalition = "blue",
				minscore = 0.0,
